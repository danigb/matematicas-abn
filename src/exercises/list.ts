...
export const MUTLIPLICACION_CON_REJILLA: Group = {
  title: "Multiplicación con rejilla",
  description: "Practica la multiplicación con el método ABN",
  exercises: [
    {
      title: "Multiplicar números de dos dígitos",
      url: "/multiplicar-con-rejilla/dos-digitos",
      description: `Por ejemplo, 54 x 2 = 108`,
    },
  ],
};
